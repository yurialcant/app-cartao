# Script para criar suite de testes E2E básicos

$ErrorActionPreference = "Stop"

Write-Host "`n╔══════════════════════════════════════════════════════════════╗" -ForegroundColor Cyan
Write-Host "║                                                              ║" -ForegroundColor Cyan
Write-Host "║     🧪 CRIANDO SUITE DE TESTES E2E 🧪                        ║" -ForegroundColor Cyan
Write-Host "║                                                              ║" -ForegroundColor Cyan
Write-Host "╚══════════════════════════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
# Criar script PowerShell para testes E2E
$testScript = @'
...
$testScriptPath = Join-Path $testsDir "run-all-e2e-tests.ps1"
Set-Content -Path $testScriptPath -Value $testScript -Encoding UTF8

Write-Host "  ✓ Suite de testes E2E criada: tests/e2e/run-all-e2e-tests.ps1" -ForegroundColor Green
Write-Host "`n✅ Suite de testes criada!" -ForegroundColor Green
Write-Host "`n📋 Para executar os testes:" -ForegroundColor Yellow
Write-Host "  .\tests\e2e\run-all-e2e-tests.ps1" -ForegroundColor White
Write-Host ""
